export const contentRu = {
  ...
  projects: [
    ...
    },
    {
      id: 'ab-marketplace',
      name: 'AB Marketplace',
      type: 'Цифровой маркетплейс',
      typeColor: '#FF4FA3',
      typeBg: '#FFF0F6',
      desc: 'Шаблоны сайтов, AI промпты, Roblox активы, анимации — всё в одном месте.',
      gradient: 'linear-gradient(135deg, #4a0030 0%, #9d1a6e 50%, #FF4FA3 100%)',
      emoji: '🛍️',
      image: '/project-ab-marketplace.jpg',
      fullDesc: 'Маркетплейс цифровых продуктов — шаблоны сайтов, математические анимации Manim, AI-промпты, UI-киты Roblox, дизайн-шаблоны и инструменты для разработчиков. Трёхъязычный интерфейс (КЗ/РУ/EN), фильтрация по категориям, живой чат с ботом и оператором, система регистрации продавцов.',
      tags: ['HTML', 'CSS', 'JavaScript', 'Chat Bot', 'КЗ/РУ/EN', 'Netlify'],
      stats: [
        { value: '31', label: 'Товаров' },
        { value: '3', label: 'Языка' },
        { value: 'Live', label: 'Статус' },
      ],
      gallery: [],
      link: 'https://ab-marketplace.netlify.app',
      linkLabel: 'Открыть маркетплейс →',
    },
    {
      id: 'gotabanim',
      ...
      typeColor: '#0EA5E9',
      typeBg: '#F0F9FF',
      desc: 'Платформа с анимированными уроками математики на Manim для казахстанских школьников.',
      gradient: 'linear-gradient(135deg, #0c1a3a 0%, #0369a1 50%, #0EA5E9 100%)',
      emoji: '🎬',
      image: '/project-gotabanim.jpg',
      fullDesc: 'Образовательная платформа с анимированными уроками математики на Python Manim. Охватывает алгебру, геометрию, математический анализ, статистику и теорию вероятностей для казахстанских школьников. Доступна на gotabanim.kz на казахском и русском языках.',
      tags: ['Python', 'Manim', 'Математика', 'КЗ/РУ', 'Образование'],
      stats: [
        { value: 'КЗ/РУ', label: 'Языки' },
      ...
      linkLabel: 'Открыть gotabanim.kz →',
    },
  ],
