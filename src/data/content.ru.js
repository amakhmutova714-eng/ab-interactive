export const contentRu = {
  ...
  widget: {
    msgs: [
      "Привет! Добро пожаловать в AB.interactive! 👋",
      "Я твой цифровой помощник!",
      "Ищешь проект или услугу?",
      "Прокрути вниз, чтобы увидеть мои работы!",
      "Давай сотрудничать! Instagram: @ab.interactive 📸",
