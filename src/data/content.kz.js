export const contentKz = {
  ...
  widget: {
    msgs: [
      "Сәлем! AB.interactive-ке қош келдің! 👋",
      "Мен сенің цифрлық көмекшіңмін!",
      "Жоба немесе қызмет іздеп жатырсың ба?",
      "Менің жұмыстарыма жылжып қара!",
      "Бірге жұмыс жасайық? Инстаграм: @ab.interactive 📸",
      "Сұрақ болса — сұра! 😊",
    ],
  },
}
