export const contentKz = {
  ...
  projects: [
    ...
    },
    {
      id: 'ab-marketplace',
      name: 'AB Marketplace',
      type: 'Цифрлық Маркетплейс',
      typeColor: '#FF4FA3',
      typeBg: '#FFF0F6',
      desc: 'Сайт шаблондары, AI промпттар, Roblox активтері, анимациялар — бәрі бір жерде.',
      gradient: 'linear-gradient(135deg, #4a0030 0%, #9d1a6e 50%, #FF4FA3 100%)',
      emoji: '🛍️',
      image: '/project-ab-marketplace.jpg',
      fullDesc: 'Шығармашыл цифрлық өнімдердің маркетплейсі — сайт шаблондары, Manim математикалық анимациялары, AI промпт жинақтары, Roblox UI жиынтықтары, дизайн шаблондары және developer құралдары. Үш тілді интерфейс (ҚЗ/РУ/EN), санаттар бойынша сүзгілеу, бот + оператор режимі бар live chat, және сатушы тіркеу жүйесі.',
      tags: ['HTML', 'CSS', 'JavaScript', 'Chat Bot', 'ҚЗ/РУ/EN', 'Netlify'],
      stats: [
        { value: '31', label: 'Өнім' },
        { value: '3', label: 'Тіл' },
        { value: 'Live', label: 'Күй' },
      ],
      gallery: [],
      link: 'https://ab-marketplace.netlify.app',
      linkLabel: 'Маркетплейске өту →',
    },
    {
      id: 'gotabanim',
      name: 'GoTAB Animations',
      type: 'Білім Платформасы',
      typeColor: '#0EA5E9',
      typeBg: '#F0F9FF',
      desc: 'Қазақстан оқушылары үшін Manim анимацияларымен математика сабақтары.',
      gradient: 'linear-gradient(135deg, #0c1a3a 0%, #0369a1 50%, #0EA5E9 100%)',
      emoji: '🎬',
      image: '/project-gotabanim.jpg',
      fullDesc: 'Python Manim арқылы жасалған анимацияланған математика сабақтары бар білім платформасы. Қазақстан мектеп оқушылары үшін алгебра, геометрия, математикалық анализ, статистика және ықтималдылықты қамтиды. gotabanim.kz сайтында қазақша және орысша қолжетімді.',
      tags: ['Python', 'Manim', 'Математика', 'ҚЗ/РУ', 'Білім'],
      stats: [
        { value: 'ҚЗ/РУ', label: 'Тіл' },
        { value: 'Manim', label: 'Движок' },
        { value: 'Live', label: 'Күй' },
      ],
      gallery: [],
      link: 'https://gotabanim-kz.onrender.com',
      linkLabel: 'gotabanim.kz-ге өту →',
    },
  ],
